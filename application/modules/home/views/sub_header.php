...
<html lang="en-US">
  ...
  <body
    ...
    data-elementor-device-mode="desktop" style="font-family: TTInterfaces-DemiBold !important;">
    <svg
                                                ...
                                                <nav migration_allowed="1" migrated="0" role="navigation" class="elementor-nav-menu--main elementor-nav-menu__container elementor-nav-menu--layout-horizontal e--pointer-none">
                                                    <ul id="menu-1-308e04f" class="elementor-nav-menu" data-smartmenus-id="16778124470928018">
                                                        ...
                                                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-10">
                                                            <a href="<?=base_url()?>index.php/home/features" class="elementor-item has-submenu" id="sm-16778124470928018-1" aria-haspopup="true" aria-controls="sm-16778124470928018-2" aria-expanded="false">
