...
<html lang="en-US">
	<head>
		...
		<link rel="stylesheet" id="google-fonts-1-css" href="<?=base_url()?><?=base_url()?>assets/css/css.css" media="all">
		...
		<script type="text/javascript" id="www-widgetapi-script" src="<?=base_url()?><?=base_url()?>assets/js/www-widgetapi.js" async=""></script><script src="<?=base_url()?>assets/iframe_api"></script><script>
		...
		</script><script src="<?=base_url()?>assets/js/wp-emoji-release.min.js" type="text/javascript" defer="defer"></script>
		...
		<link rel="stylesheet" href="<?=base_url()?>assets/css/contact.css" media="all">
		<link rel="stylesheet" id="classic-theme-styles-css" href="<?=base_url()?>assets/css/classic-themes.min.css" media="all">
		...
		<link rel="stylesheet" id="hello-elementor-css" href="<?=base_url()?>assets/css/style.min.css" media="all">
		<link rel="stylesheet" id="hello-elementor-theme-style-css" href="<?=base_url()?>assets/css/theme.min.css" media="all">
		<link rel="stylesheet" id="elementor-frontend-css" href="<?=base_url()?>assets/css/frontend-lite.min.css" media="all">
		<link rel="stylesheet" id="elementor-post-21-css" href="<?=base_url()?>assets/css/post-21.css" media="all">
		<link rel="stylesheet" id="elementor-icons-css" href="<?=base_url()?>assets/css/elementor-icons.min.css" media="all">
		<link rel="stylesheet" id="elementor-pro-css" href="<?=base_url()?>assets/css/frontend-lite.min_002.css" media="all">
		...
		<link rel="stylesheet" id="elementor-icons-ekiticons-css" href="<?=base_url()?>assets/css/ekiticons.css" media="all">
		<link rel="stylesheet" id="skb-cife-brands_icon-css" href="<?=base_url()?>assets/css/icomoon_brands.css" media="all">
		<link rel="stylesheet" id="skb-cife-devicons_icon-css" href="<?=base_url()?>assets/css/devicons.min.css" media="all">
		<link rel="stylesheet" id="skb-cife-elegant_icon-css" href="<?=base_url()?>assets/css/elegant.css" media="all">
		<link rel="stylesheet" id="skb-cife-elusive_icon-css" href="<?=base_url()?>assets/css/elusive-icons.min.css" media="all">
		<link rel="stylesheet" id="skb-cife-icofont_icon-css" href="<?=base_url()?>assets/css/icofont.min.css" media="all">
		<link rel="stylesheet" id="skb-cife-icomoon_icon-css" href="<?=base_url()?>assets/css/icomoon.css" media="all">
		<link rel="stylesheet" id="skb-cife-iconic_icon-css" href="<?=base_url()?>assets/css/iconic.css" media="all">
		<link rel="stylesheet" id="skb-cife-ion_icon-css" href="<?=base_url()?>assets/css/ionicons.min.css" media="all">
		<link rel="stylesheet" id="skb-cife-linearicons_icon-css" href="<?=base_url()?>assets/css/linearicons.css" media="all">
