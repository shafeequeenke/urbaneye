				...
				<div class="row add-question-wrapper">
					...
					<?=form_open_multipart('question/create',$createQuestionForm)?>
						...
						<div class="add-form">
							...
							<textarea class="form-control question-text-area" name="question_text" placeholder="Type here..." data-sample-short><?=(isset($complex_question_text)?$complex_question_text:'')?></textarea>
						</div>
						<div class="add-form">
						...
						<div class="text-right add-form">
							...
							<input type="hidden" id="questionType" value="text/html">
